...
``__CUDA_FTZ=[0,1]``       Use optimized code paths that flush subnormals
                           to zero
``__CUDA_PREC_SQRT=[0,1]`` Use the IEEE round-to-nearest square root
                           (default: 1) rather than the approximate one
========================== ================================================

The values of these flags are determined by the "nvvm-reflect-ftz" and
"nvvm-reflect-prec-sqrt" module flags.  The following sets the ftz flag to 1.
