...
; DAGCombine used to loop forever here: matchPERM built its PERM operand as a
; v2i16 build_vector of the source's elements, which the post-legalization
; combiner immediately re-lowered into the (or (zext lo), (shl (zext hi), 16))
; pattern that performOrCombine had just matched, over and over.
