...
define amdgpu_kernel void @udiv_i32_and_i24_no_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: udiv_i32_and_i24_no_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: udiv_i32_and_i24_no_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
define amdgpu_kernel void @urem_i32_and_i24_no_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: urem_i32_and_i24_no_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: urem_i32_and_i24_no_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
define amdgpu_kernel void @udiv_i32_and_i22_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: udiv_i32_and_i22_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_mov_b32 s2, 0x3fffff
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: udiv_i32_and_i22_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX90A-NEXT:    s_mov_b32 s2, 0x3fffff
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NEXT:    global_store_dword v0, v1, s[0:1]
; GFX90A-NEXT:    s_endpgm
  %dividend = and i32 %input, u0x3fffff
  %divisor = or i32 %dividend, 1
  %result = udiv i32 %dividend, %divisor
  store i32 %result, ptr addrspace(1) %out, align 4
  ret void
...
define amdgpu_kernel void @urem_i32_and_i22_fast_path(ptr addrspace(1) %out, i32 %input) {
; GFX950-LABEL: urem_i32_and_i22_fast_path:
; GFX950:       ; %bb.0:
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dword s0, s[4:5], 0x2c
...
; GFX950-NEXT:    s_endpgm
;
; GFX90A-LABEL: urem_i32_and_i22_fast_path:
; GFX90A:       ; %bb.0:
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_load_dword s0, s[4:5], 0x2c
