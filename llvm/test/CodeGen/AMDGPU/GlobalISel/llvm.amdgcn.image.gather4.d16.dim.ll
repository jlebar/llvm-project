...
; The sq block of gfx8.1 and gfx9 does not estimate register use correctly for
; d16 image_gather4 instructions; they must declare one destination register
; per dmask lane even though the data only occupies two packed registers.
