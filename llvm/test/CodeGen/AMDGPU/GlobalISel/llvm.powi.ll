...
; GFX7-NEXT:    v_cvt_f32_i32_e32 v3, v1
; GFX7-NEXT:    v_mov_b32_e32 v4, 0x42000000
...
; GFX7-NEXT:    v_mul_legacy_f32_e32 v2, v3, v2
...
; GFX7-NEXT:    v_cndmask_b32_e32 v0, 1.0, v0, vcc
...
; GFX11-TRUE16-NEXT:    v_cvt_f32_i32_e32 v3, v1
...
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v0, 5, v0
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_mul_dx9_zero_f32_e32 v0, v0, v3
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v1, 1.0, v2, vcc_lo
; GFX11-TRUE16-NEXT:    v_exp_f32_e32 v0, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v1, 0x80000000, v1
; GFX11-TRUE16-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-TRUE16-NEXT:    v_ldexp_f32 v0, v0, v3
; GFX11-TRUE16-NEXT:    v_and_or_b32 v0, 0x7fffffff, v0, v1
...
; GFX11-FAKE16-NEXT:    v_cvt_f32_i32_e32 v3, v1
...
; GFX11-FAKE16-NEXT:    v_and_b32_e32 v0, 0x80000000, v0
; GFX11-FAKE16-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-FAKE16-NEXT:    v_ldexp_f32 v1, v2, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-FAKE16-NEXT:    v_and_or_b32 v0, 0x7fffffff, v1, v0
...
; GFX11-NEXT:    v_cvt_f32_i32_e32 v4, v1
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_mul_dx9_zero_f32_e32 v2, v4, v2
...
; GFX11-NEXT:    s_waitcnt_depctr depctr_va_vdst(0)
; GFX11-NEXT:    v_ldexp_f32 v1, v2, v3
