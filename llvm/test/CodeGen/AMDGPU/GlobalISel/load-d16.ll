...
; The load must not be moved to the merge point past an aliasing store.
define amdgpu_ps void @load_P1_B16_D16_store_in_between(<2 x i16> %vec, ptr addrspace(1) %ptra, ptr addrspace(1) %out) {
; GFX12-TRUE16-LABEL: load_P1_B16_D16_store_in_between:
; GFX12-TRUE16:       ; %bb.0:
; GFX12-TRUE16-NEXT:    global_load_u16 v6, v[1:2], off
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v5.l, -1
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_and_or_b32 v0, 0xffff0000, v0, v6
; GFX12-TRUE16-NEXT:    global_store_b16 v[1:2], v5, off
; GFX12-TRUE16-NEXT:    global_store_b32 v[3:4], v0, off
; GFX12-TRUE16-NEXT:    s_endpgm
;
; GFX12-FAKE16-LABEL: load_P1_B16_D16_store_in_between:
; GFX12-FAKE16:       ; %bb.0:
; GFX12-FAKE16-NEXT:    global_load_u16 v5, v[1:2], off
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v6, -1
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    v_and_or_b32 v0, 0xffff0000, v0, v5
; GFX12-FAKE16-NEXT:    global_store_b16 v[1:2], v6, off
; GFX12-FAKE16-NEXT:    global_store_b32 v[3:4], v0, off
; GFX12-FAKE16-NEXT:    s_endpgm
  %a = load i16, ptr addrspace(1) %ptra
  store i16 -1, ptr addrspace(1) %ptra
  %res = insertelement <2 x i16> %vec, i16 %a, i32 0
  store <2 x i16> %res, ptr addrspace(1) %out
  ret void
}

; A volatile load must not be duplicated into a D16 load.
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    global_load_u16 v1, v[1:2], off scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_and_or_b32 v0, 0xffff0000, v0, v1
; GFX12-NEXT:    global_store_b32 v[3:4], v0, off
; GFX12-NEXT:    s_endpgm
