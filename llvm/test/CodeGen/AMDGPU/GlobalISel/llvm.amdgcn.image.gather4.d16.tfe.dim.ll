...
; With tfe the gfx8.1/gfx9 d16 image_gather4 bug workaround requires five
; declared destination registers: four for the dmask lanes plus one for the
; status dword, of which only the first three hold data.
