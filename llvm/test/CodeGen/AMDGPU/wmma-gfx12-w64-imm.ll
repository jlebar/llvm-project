...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_mov_b32_e32 v7, 0x40400000
...
; GCN-NEXT:    v_wmma_f32_16x16x16_f16 v[7:10], v[0:1], v[2:3], v[7:10]
; GCN-NEXT:    global_store_b128 v[4:5], v[7:10], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v9, v7
; GCN-NEXT:    v_mov_b32_e32 v10, v7
; GCN-NEXT:    v_wmma_f32_16x16x16_bf16 v[7:10], v[0:1], v[2:3], v[7:10]
; GCN-NEXT:    global_store_b128 v[4:5], v[7:10], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_mov_b32_e32 v7, 0x42004200
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_mov_b32_e32 v8, v7
; GCN-NEXT:    v_wmma_f16_16x16x16_f16 v[7:8], v[0:1], v[2:3], v[7:8]
; GCN-NEXT:    global_store_b64 v[4:5], v[7:8], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_mov_b32_e32 v7, 0x3f803f80
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_mov_b32_e32 v8, v7
; GCN-NEXT:    v_wmma_bf16_16x16x16_bf16 v[7:8], v[0:1], v[2:3], v[7:8]
; GCN-NEXT:    global_store_b64 v[4:5], v[7:8], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_mov_b32_e32 v7, 0x3fc03fc0
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_mov_b32_e32 v8, v7
; GCN-NEXT:    v_wmma_bf16_16x16x16_bf16 v[7:8], v[0:1], v[2:3], v[7:8]
; GCN-NEXT:    global_store_b64 v[4:5], v[7:8], off
...
; GCN-NEXT:    v_wmma_i32_16x16x16_iu8 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v8, v6
; GCN-NEXT:    v_mov_b32_e32 v9, v6
; GCN-NEXT:    v_wmma_i32_16x16x16_iu4 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v8, v6
; GCN-NEXT:    v_mov_b32_e32 v9, v6
; GCN-NEXT:    v_wmma_f32_16x16x16_fp8_fp8 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v8, v6
; GCN-NEXT:    v_mov_b32_e32 v9, v6
; GCN-NEXT:    v_wmma_f32_16x16x16_bf8_fp8 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v8, v6
; GCN-NEXT:    v_mov_b32_e32 v9, v6
; GCN-NEXT:    v_wmma_f32_16x16x16_fp8_bf8 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v8, v6
; GCN-NEXT:    v_mov_b32_e32 v9, v6
; GCN-NEXT:    v_wmma_f32_16x16x16_bf8_bf8 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v8, v6
; GCN-NEXT:    v_mov_b32_e32 v9, v6
; GCN-NEXT:    v_wmma_i32_16x16x32_iu4 v[6:9], v0, v1, v[6:9]
; GCN-NEXT:    global_store_b128 v[2:3], v[6:9], off
; GCN-NEXT:    s_endpgm
bb:
