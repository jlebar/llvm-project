...
; COEXEC-NEXT:    ds_load_tr16_b128 v[38:41], v32 offset:192
; COEXEC-NEXT:    ds_load_tr16_b128 v[34:37], v32 offset:128
; COEXEC-NEXT:    ds_load_tr16_b128 v[42:45], v32
; COEXEC-NEXT:    ds_load_tr16_b128 v[46:49], v32 offset:64
...
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[42:49], v[34:41], v[24:31]
; COEXEC-NEXT:    s_wait_dscnt 0x8
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[58:65], v[50:57], v[16:23]
; COEXEC-NEXT:    s_wait_dscnt 0x4
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[74:81], v[66:73], v[8:15]
...
; GCN-NEXT:    ds_load_tr16_b128 v[34:37], v32
; GCN-NEXT:    ds_load_tr16_b128 v[38:41], v32 offset:64
; GCN-NEXT:    ds_load_tr16_b128 v[42:45], v32 offset:128
; GCN-NEXT:    ds_load_tr16_b128 v[46:49], v32 offset:192
...
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[34:41], v[42:49], v[24:31]
; GCN-NEXT:    s_wait_dscnt 0x8
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[50:57], v[58:65], v[16:23]
; GCN-NEXT:    s_wait_dscnt 0x4
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[66:73], v[74:81], v[8:15]
...
; COEXEC-NEXT:    v_mov_b32_e32 v32, s7
; COEXEC-NEXT:    s_cmp_lg_u32 s9, 1
; COEXEC-NEXT:    v_mov_b32_e32 v33, s8
; COEXEC-NEXT:    ds_load_tr16_b128 v[34:37], v32
; COEXEC-NEXT:    ds_load_tr16_b128 v[38:41], v32 offset:64
; COEXEC-NEXT:    ds_load_tr16_b128 v[42:45], v33
; COEXEC-NEXT:    ds_load_tr16_b128 v[46:49], v33 offset:64
; COEXEC-NEXT:    ds_load_tr16_b128 v[54:57], v32 offset:320
; COEXEC-NEXT:    ds_load_tr16_b128 v[50:53], v32 offset:256
; COEXEC-NEXT:    ds_load_tr16_b128 v[58:61], v33 offset:256
; COEXEC-NEXT:    ds_load_tr16_b128 v[62:65], v33 offset:320
; COEXEC-NEXT:    ds_load_tr16_b128 v[70:73], v32 offset:576
; COEXEC-NEXT:    ds_load_tr16_b128 v[66:69], v32 offset:512
; COEXEC-NEXT:    ds_load_tr16_b128 v[78:81], v33 offset:576
; COEXEC-NEXT:    ds_load_tr16_b128 v[74:77], v33 offset:512
; COEXEC-NEXT:    ds_load_tr16_b128 v[86:89], v32 offset:832
; COEXEC-NEXT:    ds_load_tr16_b128 v[82:85], v32 offset:768
; COEXEC-NEXT:    ds_load_tr16_b128 v[94:97], v33 offset:832
; COEXEC-NEXT:    ds_load_tr16_b128 v[90:93], v33 offset:768
; COEXEC-NEXT:    ds_load_tr16_b128 v[98:101], v32 offset:128
; COEXEC-NEXT:    ds_load_tr16_b128 v[102:105], v32 offset:192
; COEXEC-NEXT:    ds_load_tr16_b128 v[106:109], v32 offset:384
; COEXEC-NEXT:    ds_load_tr16_b128 v[110:113], v32 offset:448
; COEXEC-NEXT:    ds_load_tr16_b128 v[114:117], v32 offset:640
; COEXEC-NEXT:    ds_load_tr16_b128 v[118:121], v32 offset:704
; COEXEC-NEXT:    ds_load_tr16_b128 v[122:125], v32 offset:896
; COEXEC-NEXT:    s_wait_dscnt 0x13
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[34:41], v[42:49], v[24:31]
; COEXEC-NEXT:    ds_load_tr16_b128 v[126:129], v32 offset:960
; COEXEC-NEXT:    ds_load_tr16_b128 v[130:133], v33 offset:128
; COEXEC-NEXT:    ds_load_tr16_b128 v[134:137], v33 offset:192
; COEXEC-NEXT:    ds_load_tr16_b128 v[138:141], v33 offset:384
; COEXEC-NEXT:    ds_load_tr16_b128 v[142:145], v33 offset:448
; COEXEC-NEXT:    ds_load_tr16_b128 v[146:149], v33 offset:640
; COEXEC-NEXT:    ds_load_tr16_b128 v[150:153], v33 offset:704
; COEXEC-NEXT:    s_wait_dscnt 0x16
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[50:57], v[58:65], v[16:23]
; COEXEC-NEXT:    ds_load_tr16_b128 v[154:157], v33 offset:896
; COEXEC-NEXT:    ds_load_tr16_b128 v[158:161], v33 offset:960
; COEXEC-NEXT:    s_wait_dscnt 0x14
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[66:73], v[74:81], v[8:15]
; COEXEC-NEXT:    s_wait_dscnt 0x10
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[82:89], v[90:97], v[0:7]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[34:41], v[42:49], v[24:31]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[50:57], v[58:65], v[16:23]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[66:73], v[74:81], v[8:15]
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[82:89], v[90:97], v[0:7]
; COEXEC-NEXT:    s_wait_dscnt 0x6
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[98:105], v[130:137], v[24:31]
; COEXEC-NEXT:    s_wait_dscnt 0x4
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[106:113], v[138:145], v[16:23]
; COEXEC-NEXT:    s_wait_dscnt 0x2
; COEXEC-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[114:121], v[146:153], v[8:15]
; COEXEC-NEXT:    s_wait_dscnt 0x0
...
; GCN-NEXT:    v_dual_mov_b32 v32, s7 :: v_dual_mov_b32 v33, s8
; GCN-NEXT:    s_add_co_i32 s6, s6, s1
; GCN-NEXT:    s_and_b32 s7, s0, exec_lo
; GCN-NEXT:    s_cselect_b32 s7, 1, 0
; GCN-NEXT:    ds_load_tr16_b128 v[34:37], v32
; GCN-NEXT:    ds_load_tr16_b128 v[38:41], v32 offset:64
; GCN-NEXT:    ds_load_tr16_b128 v[42:45], v33
; GCN-NEXT:    ds_load_tr16_b128 v[46:49], v33 offset:64
; GCN-NEXT:    ds_load_tr16_b128 v[50:53], v32 offset:256
; GCN-NEXT:    ds_load_tr16_b128 v[54:57], v32 offset:320
; GCN-NEXT:    ds_load_tr16_b128 v[58:61], v33 offset:256
; GCN-NEXT:    ds_load_tr16_b128 v[62:65], v33 offset:320
; GCN-NEXT:    ds_load_tr16_b128 v[66:69], v32 offset:512
; GCN-NEXT:    ds_load_tr16_b128 v[70:73], v32 offset:576
; GCN-NEXT:    ds_load_tr16_b128 v[74:77], v33 offset:512
; GCN-NEXT:    ds_load_tr16_b128 v[78:81], v33 offset:576
; GCN-NEXT:    ds_load_tr16_b128 v[82:85], v32 offset:768
; GCN-NEXT:    ds_load_tr16_b128 v[86:89], v32 offset:832
; GCN-NEXT:    ds_load_tr16_b128 v[90:93], v33 offset:768
; GCN-NEXT:    ds_load_tr16_b128 v[94:97], v33 offset:832
...
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[82:89], v[90:97], v[0:7]
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[34:41], v[42:49], v[24:31]
; GCN-NEXT:    ds_load_tr16_b128 v[34:37], v32 offset:128
; GCN-NEXT:    ds_load_tr16_b128 v[38:41], v32 offset:192
; GCN-NEXT:    ds_load_tr16_b128 v[42:45], v33 offset:128
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[50:57], v[58:65], v[16:23]
; GCN-NEXT:    ds_load_tr16_b128 v[46:49], v33 offset:192
; GCN-NEXT:    ds_load_tr16_b128 v[50:53], v32 offset:384
; GCN-NEXT:    ds_load_tr16_b128 v[54:57], v32 offset:448
; GCN-NEXT:    ds_load_tr16_b128 v[58:61], v33 offset:384
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[8:15], v[66:73], v[74:81], v[8:15]
; GCN-NEXT:    ds_load_tr16_b128 v[62:65], v33 offset:448
; GCN-NEXT:    ds_load_tr16_b128 v[66:69], v32 offset:640
; GCN-NEXT:    ds_load_tr16_b128 v[70:73], v32 offset:704
; GCN-NEXT:    ds_load_tr16_b128 v[74:77], v33 offset:640
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[0:7], v[82:89], v[90:97], v[0:7]
; GCN-NEXT:    ds_load_tr16_b128 v[78:81], v33 offset:704
; GCN-NEXT:    ds_load_tr16_b128 v[82:85], v32 offset:896
; GCN-NEXT:    ds_load_tr16_b128 v[86:89], v32 offset:960
; GCN-NEXT:    ds_load_tr16_b128 v[90:93], v33 offset:896
; GCN-NEXT:    ds_load_tr16_b128 v[94:97], v33 offset:960
; GCN-NEXT:    s_wait_dscnt 0xc
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[24:31], v[34:41], v[42:49], v[24:31]
; GCN-NEXT:    s_wait_dscnt 0x8
; GCN-NEXT:    v_wmma_f32_16x16x32_f16 v[16:23], v[50:57], v[58:65], v[16:23]
