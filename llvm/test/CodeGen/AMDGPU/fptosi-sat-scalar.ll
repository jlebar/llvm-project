...
; GFX7-GI-NEXT:    v_mov_b32_e32 v2, 0xcf800000
; GFX7-GI-NEXT:    v_bfrev_b32_e32 v4, 1
; GFX7-GI-NEXT:    v_trunc_f32_e32 v3, v0
; GFX7-GI-NEXT:    v_mul_f32_e64 v1, |v3|, v1
; GFX7-GI-NEXT:    v_floor_f32_e32 v1, v1
; GFX7-GI-NEXT:    v_fma_f32 v2, v1, v2, |v3|
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX7-GI-NEXT:    v_ashrrev_i32_e32 v3, 31, v0
; GFX7-GI-NEXT:    v_xor_b32_e32 v2, v2, v3
; GFX7-GI-NEXT:    v_xor_b32_e32 v1, v1, v3
; GFX7-GI-NEXT:    v_sub_i32_e32 v2, vcc, v2, v3
; GFX7-GI-NEXT:    v_subb_u32_e32 v1, vcc, v1, v3, vcc
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, 0xdf000000
; GFX7-GI-NEXT:    v_cmp_nge_f32_e32 vcc, v0, v3
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, 0x5effffff
; GFX7-GI-NEXT:    v_cndmask_b32_e64 v2, v2, 0, vcc
; GFX7-GI-NEXT:    v_cndmask_b32_e32 v1, v1, v4, vcc
; GFX7-GI-NEXT:    v_bfrev_b32_e32 v4, -2
; GFX7-GI-NEXT:    v_cmp_gt_f32_e32 vcc, v0, v3
...
; GFX7-GI-NEXT:    s_or_b64 s[4:5], vcc, vcc
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, 0x5effffff
; GFX7-GI-NEXT:    s_mov_b32 s4, 0
; GFX7-GI-NEXT:    s_brev_b32 s5, 1
; GFX7-GI-NEXT:    v_cmp_gt_f32_e32 vcc, v0, v1
; GFX7-GI-NEXT:    s_cselect_b64 s[4:5], s[4:5], s[6:7]
; GFX7-GI-NEXT:    s_or_b64 s[6:7], vcc, vcc
; GFX7-GI-NEXT:    s_mov_b32 s6, -1
; GFX7-GI-NEXT:    s_brev_b32 s7, -2
...
; GFX12-GI-NEXT:    s_wait_bvhcnt 0x0
; GFX12-GI-NEXT:    s_wait_kmcnt 0x0
; GFX12-GI-NEXT:    s_cvt_f32_f16 s6, s0
; GFX12-GI-NEXT:    s_mov_b32 s4, 0
; GFX12-GI-NEXT:    s_brev_b32 s5, 1
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_trunc_f32 s0, s6
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_and_b32 s1, s0, 0x7fffffff
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_mul_f32 s0, s1, 0x2f800000
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_floor_f32 s2, s0
; GFX12-GI-NEXT:    s_ashr_i32 s0, s6, 31
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_fmac_f32 s1, s2, 0xcf800000
; GFX12-GI-NEXT:    s_cvt_u32_f32 s3, s2
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_cvt_u32_f32 s2, s1
; GFX12-GI-NEXT:    s_mov_b32 s1, s0
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_xor_b64 s[2:3], s[2:3], s[0:1]
; GFX12-GI-NEXT:    s_cmp_nge_f32 s6, 0xdf000000
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_sub_nc_u64 s[0:1], s[2:3], s[0:1]
; GFX12-GI-NEXT:    s_mov_b32 s2, -1
; GFX12-GI-NEXT:    s_brev_b32 s3, -2
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_cselect_b64 s[0:1], s[4:5], s[0:1]
; GFX12-GI-NEXT:    s_cmp_gt_f32 s6, 0x5effffff
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_cselect_b64 s[0:1], s[2:3], s[0:1]
; GFX12-GI-NEXT:    s_cmp_u_f32 s6, s6
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    s_cselect_b64 s[0:1], 0, s[0:1]
; GFX12-GI-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-GI-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
