...
; GFX12-GISEL-NEXT:    s_wait_bvhcnt 0x0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    flat_load_b32 v3, v[0:1]
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
; GFX12-GISEL-NEXT:  .LBB21_1: ; %atomicrmw.start
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v4, v3
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-GISEL-NEXT:    v_sub_nc_u32_e64 v3, v4, v2 clamp
; GFX12-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX12-GISEL-NEXT:    flat_atomic_cmpswap_b32 v3, v[0:1], v[3:4] th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-GISEL-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-GISEL-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v4
; GFX12-GISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-SDAG-NEXT:    s_wait_bvhcnt 0x0
; GFX12-SDAG-NEXT:    s_wait_kmcnt 0x0
; GFX12-SDAG-NEXT:    flat_load_b32 v3, v[0:1]
; GFX12-SDAG-NEXT:    s_mov_b32 s0, 0
; GFX12-SDAG-NEXT:  .LBB21_1: ; %atomicrmw.start
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v4, v3
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_sub_nc_u32_e64 v3, v4, v2 clamp
; GFX12-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX12-SDAG-NEXT:    flat_atomic_cmpswap_b32 v3, v[0:1], v[3:4] th:TH_ATOMIC_RETURN scope:SCOPE_DEV
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-SDAG-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v3, v4
; GFX12-SDAG-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-SDAG-NEXT:    s_setpc_b64 s[30:31]
  %ret = atomicrmw usub_sat ptr %ptr, i32 %data syncscope("agent") seq_cst, align 4, !amdgpu.no.remote.memory !0
  ret i32 %ret
}
...
; GFX12-GISEL-NEXT:    s_wait_bvhcnt 0x0
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    flat_load_b32 v4, v[0:1]
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
; GFX12-GISEL-NEXT:  .LBB22_1: ; %atomicrmw.start
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-GISEL-NEXT:    v_sub_nc_u32_e64 v3, v4, v2 clamp
; GFX12-GISEL-NEXT:    s_wait_storecnt 0x0
...
; GFX12-SDAG-NEXT:    s_mov_b32 s0, 0
; GFX12-SDAG-NEXT:  .LBB22_1: ; %atomicrmw.start
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-SDAG-NEXT:    v_sub_nc_u32_e64 v3, v4, v2 clamp
; GFX12-SDAG-NEXT:    s_wait_storecnt 0x0
...
; GFX12-GISEL-NEXT:    flat_load_b32 v3, v[0:1]
; GFX12-GISEL-NEXT:    s_mov_b32 s0, 0
; GFX12-GISEL-NEXT:  .LBB23_1: ; %atomicrmw.start
; GFX12-GISEL-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v4, v3
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-SDAG-NEXT:    flat_load_b32 v3, v[0:1]
; GFX12-SDAG-NEXT:    s_mov_b32 s0, 0
; GFX12-SDAG-NEXT:  .LBB23_1: ; %atomicrmw.start
; GFX12-SDAG-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v4, v3
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-SDAG-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-SDAG-NEXT:    s_and_not1_b32 exec_lo, exec_lo, s0
; GFX12-SDAG-NEXT:    s_cbranch_execnz .LBB23_1
; GFX12-SDAG-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX12-SDAG-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-SDAG-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-SDAG-NEXT:    v_sub_u32_e64 v2, v3, v1 clamp
; GFX9-SDAG-NEXT:    ds_cmpst_rtn_b32 v2, v0, v3, v2
; GFX9-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    v_mov_b32_e32 v3, v2
; GFX10-SDAG-NEXT:    v_sub_nc_u32_e64 v2, v3, v1 clamp
; GFX10-SDAG-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-SDAG-NEXT:    ds_cmpst_rtn_b32 v2, v0, v3, v2
; GFX10-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-SDAG-NEXT:    buffer_gl0_inv
; GFX10-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v2, v3
; GFX10-SDAG-NEXT:    s_or_b32 s4, vcc_lo, s4
...
; GFX11-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-SDAG-NEXT:    v_sub_nc_u32_e64 v2, v3, v1 clamp
; GFX11-SDAG-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-SDAG-NEXT:    ds_cmpstore_rtn_b32 v2, v0, v2, v3
; GFX11-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-SDAG-NEXT:    buffer_gl0_inv
...
; GFX12-SDAG-NEXT:    s_setpc_b64 s[30:31]
  %ret = atomicrmw usub_sat ptr addrspace(3) %ptr, i32 %data seq_cst, align 4
  ret i32 %ret
}
