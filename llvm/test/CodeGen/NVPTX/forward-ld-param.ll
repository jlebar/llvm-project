...
define i32 @test_ld_param_mixed_const_non_const(ptr byval([10 x i32]) %a, i32 %b) {
; CHECK-LABEL: test_ld_param_mixed_const_non_const(
; CHECK:       {
; CHECK-NEXT:    .reg .b32 %r<4>;
; CHECK-NEXT:    .reg .b64 %rd<4>;
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    mov.b64 %rd1, test_ld_param_mixed_const_non_const_param_0;
; CHECK-NEXT:    ld.param.s32 %rd2, [test_ld_param_mixed_const_non_const_param_1];
; CHECK-NEXT:    ld.param.b32 %r1, [test_ld_param_mixed_const_non_const_param_0+4];
; CHECK-NEXT:    add.s64 %rd3, %rd1, %rd2;
; CHECK-NEXT:    ld.local.b32 %r2, [%rd3];
; CHECK-NEXT:    add.s32 %r3, %r1, %r2;
; CHECK-NEXT:    st.param.b32 [func_retval0], %r3;
; CHECK-NEXT:    ret;
  %p1 = getelementptr i8, ptr %a, i32 4
  %v1 = load i32, ptr %p1
  %p2 = getelementptr i8, ptr %a, i32 %b
  %v2 = load i32, ptr %p2
  %v = add i32 %v1, %v2
...
define i32 @test_ld_param_non_const_store(ptr byval([10 x i32]) %a, i32 %b) {
; CHECK-LABEL: test_ld_param_non_const_store(
; CHECK:       {
; CHECK-NEXT:    .reg .b32 %r<2>;
; CHECK-NEXT:    .reg .b64 %rd<4>;
; CHECK-EMPTY:
; CHECK-NEXT:  // %bb.0:
; CHECK-NEXT:    mov.b64 %rd1, test_ld_param_non_const_store_param_0;
; CHECK-NEXT:    ld.param.s32 %rd2, [test_ld_param_non_const_store_param_1];
; CHECK-NEXT:    add.s64 %rd3, %rd1, %rd2;
; CHECK-NEXT:    st.local.b32 [%rd3], 42;
; CHECK-NEXT:    ld.local.b32 %r1, [%rd1+4];
; CHECK-NEXT:    st.param.b32 [func_retval0], %r1;
; CHECK-NEXT:    ret;
  %p1 = getelementptr i8, ptr %a, i32 %b
  store i32 42, ptr %p1
