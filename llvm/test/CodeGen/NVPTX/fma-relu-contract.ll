...
; CHECK-SM70-EMPTY:
; CHECK-SM70-NEXT:  // %bb.0:
; CHECK-SM70-NEXT:    ld.param.b16 %r1, [fma_bf16_expanded_unsafe_with_nans_param_1];
; CHECK-SM70-NEXT:    shl.b32 %r2, %r1, 16;
; CHECK-SM70-NEXT:    ld.param.b16 %r3, [fma_bf16_expanded_unsafe_with_nans_param_0];
...
; CHECK-SM70-NEXT:    ld.param.b16 %r12, [fma_bf16_expanded_unsafe_with_nans_param_2];
...
; CHECK-SM70-NEXT:    setp.gt.f32 %p3, %r20, 0f00000000;
; CHECK-SM70-NEXT:    selp.b16 %rs2, %rs1, 0x0000, %p3;
; CHECK-SM70-NEXT:    add.f32 %r21, %r20, 0f40E00000;
...
; CHECK-SM70-NEXT:    add.f32 %r30, %r28, %r29;
...
; CHECK-SM70-NEXT:    selp.b16 %rs9, %rs8, 0x0000, %p6;
; CHECK-SM70-NEXT:    selp.b16 %rs10, %rs7, 0x0000, %p5;
; CHECK-SM70-NEXT:    add.f32 %r41, %r40, 0f40E00000;
...
; CHECK-SM70-NEXT:    add.f32 %r47, %r39, 0f40E00000;
...
; CHECK-SM70-NEXT:    add.f32 %r56, %r54, %r55;
...
; CHECK-SM70-NEXT:    add.f32 %r65, %r63, %r64;
