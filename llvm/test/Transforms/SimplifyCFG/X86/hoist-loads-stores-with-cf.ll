...
;; The masked load returns PassThru when the mask is false, so the load's
;; !range only transfers to the call after widening it over a constant
;; PassThru (the phi's other incoming value).
